...
export default function Banner() {
  return (
    <section className="font-oswald bg-[url('/images/banner-1.png')] lg:bg-none bg-cover bg-center md:bg-top bg-no-repeat mx-3.5 mb-3.5 lg:mb-8 h-60 p-3.5 lg:p-0 flex items-end lg:items-center lg:gap-8">
