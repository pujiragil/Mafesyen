  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid h-12 w-[150px] grid-cols-3 border border-[#C4C4C4]">
        <div className="grid cursor-pointer place-items-center" onClick={handleDecrement}>
          <svg width="10" height="2" viewBox="0 0 10 2" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="10" height="2" fill="#C4C4C4" />
          </svg>
        </div>

        <p className="place-self-center font-oswald text-base font-normal">{quantity}</p>

        <div className="grid cursor-pointer place-items-center" onClick={handleIncrement}>
