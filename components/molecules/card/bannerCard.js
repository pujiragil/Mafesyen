...
const BannerCardSection = ({ imageBg, color = "black" }) => {
  return (
    <SectionLayout>
      <div className="min-h-36 relative z-10 mx-3.5 grid grid-cols-[2fr_1fr] p-7 md:h-56 lg:h-72 lg:place-items-center">
        <div className="flex flex-col gap-2">
          ...
          <Text color={color} size="xs/lg" className="md:w-9/12 lg:hidden">
          ...
          <Text
            color={color}
            size="xs/lg"
            className="hidden md:w-9/12 lg:inline"
          >
          ...
          <ButtonLink color={color} href="/catalog">
            shop now
          </ButtonLink>
        </div>
        <Image
