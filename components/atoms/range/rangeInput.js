...
const RangeInput = (props) => {
  ...
  return (
    <div className="flex h-5 items-center">
      <div className="relative block h-0.5 lg:h-1 w-full bg-gray-400 before:absolute before:left-0 before:-top-[8px] before:z-0 before:h-[18px] before:w-[5px] before:bg-black">
        <input
          type="range"
          min={props.minRange}
          max={props.maxRange}
